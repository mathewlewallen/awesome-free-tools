...
- [Bruno](https://github.com/usebruno/bruno) - Offline API client that’s fast, Git-friendly, and open source. ![Windows](win.svg)
...
- [Ubisoft Connect](https://ubisoftconnect.com/) - Ubisoft’s game launcher and store for managing their titles. ![Windows](win.svg) ![macOS](mac.svg)
...
- [Bethesda Launcher](https://bethesda.net/en/game/bethesda-launcher) - Launcher for Bethesda’s games like Fallout and The Elder Scrolls series. ![Windows](win.svg)
- [EA App](https://www.ea.com/ea-app) - EA’s modern launcher replacing Origin. ![Windows](win.svg)
