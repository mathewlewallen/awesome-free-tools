...
- [FXSound](https://www.fxsound.com/) - Boost sound quality, volume, and bass. Has a beautiful modern UI. 🪟
...
- [LDPlayer](https://www.ldplayer.net/) - Lightweight Android emulator for gaming on PC. 🪟
- [NoxPlayer](https://www.bignox.com/) - Android emulator optimized for mobile gaming on desktop. 🪟 🍎
- [MEmu Play](https://www.memuplay.com/) - Powerful Android emulator with excellent gaming support. 🪟
...
- [Paint.NET](https://www.getpaint.net/index.html) - Simple yet powerful image editor for quick edits and designs. 🪟
- [PhotoFiltre](https://www.photofiltre-studio.com/pf7-en.htm) - Complete image retouching program. 🪟
...
- [Colorpicker](https://colorpicker.fr/) - Open-source color manipulation tool for picking and modifying colors. 🪟 🍎 🐧
- [Draw.io](https://github.com/jgraph/drawio-desktop) - Desktop app for creating diagrams and flowcharts. 🪟 🍎 🐧
- [FontForge](http://fontforge.github.io/) - Open-source font editor for creating and modifying font files. 🪟 🍎 🐧
...
- [KeePass](https://keepass.info/) - Lightweight and open-source password manager for secure storage of passwords in encrypted databases. 🪟 🍎 🐧
...
- [Passbolt](https://www.passbolt.com/) - Open-source, team-oriented password manager for sharing and storing passwords securely. 🪟 🍎 🐧
...
- [Irfanview](https://www.irfanview.com/) - Simple image viewer with some editing abilities. 🪟
...
- [Notepad++](https://notepad-plus-plus.org/) - A free, open-source text editor with syntax highlighting and advanced editing features for developers. 🪟
- [Sublime Text](https://www.sublimetext.com/) - A fast and customizable text editor with support for a wide range of programming languages. 🪟 🍎 🐧
...
- [Brackets](http://brackets.io/) - An open-source text editor focused on web development, with live preview and preprocessor support. 🪟 🍎 🐧
...
- [CodeEdit](https://www.codeedit.app/) - A free and open-source, lightweight native code editor for macOS. 🍎
...
- [VSDC Free Video Editor](https://www.videosoftdev.com/free-video-editor) - Non-linear video editor with a rich set of editing tools. 🪟
- [Olive Video Editor](https://www.olivevideoeditor.org/) - Open-source non-linear video editor with powerful features and an intuitive interface. 🪟 🍎 🐧
...
- [MPV](https://mpv.io/) - Open-source, cross-platform media player with a simple interface. 🪟 🍎 🐧
...
- [ScreenToGif](https://www.screentogif.com/) - Screen recording software that allows you to capture GIFs and videos with customizable export options. 🪟
...
- [IINA](https://iina.io/) - Open-source media player for macOS. Performs better than VLC. 🍎
...
- [Nginx RTMP](https://github.com/arut/nginx-rtmp-module) - Open-source media streaming server using NGINX. 🐧
- [Livestreamer](https://github.com/chrippa/livestreamer) - Command-line utility to stream video from various platforms. 🪟 🍎 🐧
- [Kaltura](https://kaltura.com/) - Open-source video streaming platform for creating and managing content. 🪟 🍎 🐧
...
- [VidCoder](https://vidcoder.net/) - Open-source video transcoder based on HandBrake, with a user-friendly interface. 🪟 🍎
- [FastFlix](https://github.com/cdgriffith/FastFlix) - GUI for H.264, HEVC and AV1 hardware and software encoding. 🪟

## VPN and Proxy Tools

- [Tunnelblick](https://github.com/Tunnelblick/Tunnelblick) - Open-source OpenVPN client for macOS with a user-friendly interface. 🍎
...
- [SpechtLite](https://github.com/zhuhaow/SpechtLite) - Open-source simplified rule-based proxy tool for macOS. 🍎
- [Specht](https://github.com/zhuhaow/Specht) - Open-source rule-based proxy app for macOS using Network Extension. 🍎
- [Twingate](https://www.twingate.com/) - Zero trust network access solution for secure private network connections. 🪟 🍎 🐧
- [ShadowsocksX-NG](https://github.com/shadowsocks/ShadowsocksX-NG) - Open-source modern Shadowsocks client with enhanced features for macOS. 🍎
- [rvc-mac](https://github.com/riboseinc/cryptode-mac) - Open-source Ribose VPN Client for macOS, providing secure VPN connections. 🍎
- [WireGuard](https://www.wireguard.com/) - Fast, modern, and secure VPN tunnel protocol designed for simplicity and performance. 🪟 🍎 🐧
- [Proxifier](https://www.proxifier.com/) - Windows-based proxy client that allows network applications to connect via a proxy server. 🪟
...
- [OpenVPN](https://openvpn.net/community-downloads/) - Open-source VPN solution for secure internet connections. 🪟
- [SoftEther VPN](https://www.softether.org/) - Free, open-source VPN software with multiple protocol support. 🪟
...
- [Maccy](https://maccy.app/) - Simple, lightweight, and open-source clipboard manager for macOS. 🍎
...
- [AltSnap](https://github.com/RamonUnch/AltSnap) - A lightweight window management tool for snapping windows to predefined positions using keyboard shortcuts. 🪟
- [AquaSnap](https://www.nurgo-software.com/products/aquasnap) - Enhances window management with docking, snapping, and stretching features for Windows. 🪟
...
- [Q-Dir](https://www.softwareok.com/?seite=Freeware/Q-Dir) - Multi-pane file manager offering up to four directory views simultaneously for enhanced productivity. 🪟
- [WinSCP](https://winscp.net/) - Open-source SFTP, FTP, WebDAV, and SCP client with a user-friendly interface. 🪟
- [Far Manager](https://www.farmanager.com/) - Program for managing files and archives in Windows. 🪟
...
- [SpaceSniffer](http://www.uderzo.it/main_products/space_sniffer/) - Visual disk space analyzer that helps identify large files and folders with an intuitive tree map. 🪟
...
- [Filelight](https://www.kde.org/applications/utilities/org.kde.filelight) - Disk usage analyzer for Linux with a circular sunburst chart to visualize file system space usage. 🪟 🍎 🐧
