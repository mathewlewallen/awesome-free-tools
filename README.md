...
- [Games](#games)
    ...
    - [Mobile Game Managers](#mobile-game-managers)
- [Video](#video)
...
- [Restbird](https://restbird.org/) - API platform for testing, automation, and mocking workflows. ![Windows](win.svg) ![macOS](mac.svg) ![Linux](nix.svg)
...
- [Riot Client](https://www.riotgames.com/en/riot-client) - Launcher for games like League of Legends, Valorant, and more. ![Windows](win.svg) ![macOS](mac.svg)
...
- [MPC-HC](https://mpc-hc.org/) - Lightweight video player with support for all common formats. ![Windows](win.svg)  
...
- [SMPlayer](https://www.smplayer.info/) - Media player that remembers your settings and automatically downloads subtitles. ![Windows](win.svg) ![macOS](mac.svg) ![Linux](nix.svg)  
